...
console.log(detail); // [ 'Bannu', 'abhi', 'chikki', 'nithin' ]
...
console.log(greaterThan70); // [ 78, 91, 100 ]
...
console.log(duplicates); // [ 2, 3, 4, 5, 6 ]

//====================================================================================

// REDUCE

// Loops through each element, condition is applied, returns a single value
...
// checks if at least one element in the array satisfies the condition and returns true or false

// Example 1

numberSOME = [10, 20, 30];

resultSOME = numberSOME.some((num) => num > 25);

console.log(resultSOME); // true

// Example 2

stringSOME1 = ["Nithin", "Pranathi", "Abhi", "Bannu"];

resultSOME1 = stringSOME1.some((name) => name === "Jacob");

console.log(resultSOME1); // false
...
numberEVERY = [10, 20, 30];

resultEVERY = numberEVERY.every((num) => num > 11);

console.log(resultEVERY); // false

// Example 2

stringEVERY1 = ["Nithin", "Pranathi", "Abhi", "Bannu"];

resultEVERY1 = stringEVERY1.every((name) => name.length >= 4);

console.log(resultEVERY1); // true
